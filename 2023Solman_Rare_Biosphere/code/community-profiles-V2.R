...
title1 <- ggdraw() + draw_label("Proportion of ASVs", size=140, hjust=2.16, vjust= 0.3, fontface = "bold")
...
title2 <- ggdraw() + draw_label("Proportion of reads", size=140, hjust=2.14, fontface = "bold")
...
title4 <- ggdraw() + draw_label("Prokaryote community profiles", size=140, hjust=1.35, fontface = "bold")
p4b = plot_grid(title4, p4a, ncol=1, rel_heights=c(0.1, 1))

title5 <- ggdraw() + draw_label("Eukaryote community profiles", size=140, hjust=1.37, fontface = "bold")
...
all.p = (all.pie1a ) / plot_spacer() / (all.pie2a) / plot_spacer() / p4b / plot_spacer() / p8b + plot_layout(heights = c(2.2,0.1,3,0.3,7.5,0.1,7.5))
