...
euk.sn.rcbray.df = get_rcbray_res(ps.euk, data.frame(sample_data(subset_samples(ps.euk, Habitat == "Snow")))$SampleID, "Microbial Eukaryote", "Snow")
euk.sp.rcbray.df = get_rcbray_res(ps.euk, data.frame(sample_data(subset_samples(ps.euk, Habitat == "Spring Ice")))$SampleID, "Microbial Eukaryote", "Spring Ice")
euk.sm.rcbray.df = get_rcbray_res(ps.euk, data.frame(sample_data(subset_samples(ps.euk, Habitat == "Summer Ice")))$SampleID, "Microbial Eukaryote", "Summer Ice")
euk.cr.rcbray.df = get_rcbray_res(ps.euk, data.frame(sample_data(subset_samples(ps.euk, Habitat == "Cryoconite")))$SampleID, "Microbial Eukaryote", "Cryoconite")

full.rcbray.df = rbind(euk.sn.rcbray.df, euk.sp.rcbray.df, euk.sm.rcbray.df, euk.cr.rcbray.df)

write.csv(full.rcbray.df, "../results/18S-RCbray-results-table.csv")
