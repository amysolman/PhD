...
rows2add2 = data.frame(Test = "Snow Vs Spring Ice", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
...
rows2add2 = data.frame(Test = "Snow Vs Summer Ice", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
...
rows2add2 = data.frame(Test = "Snow Vs Cryoconite", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
...
data2plot = data.frame(Test = "Spring Ice Vs Summer Ice", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=data2plot$Kingdom, Phylum=data2plot$Phylum, Class=data2plot$Class, Order=data2plot$Order, Family=data2plot$Family,
                       Genus=NA, Species=NA)
...
#add empty rows for all the taxa we will include
rows2add = tax.data.fam[!tax.data.fam$Family %in% data2plot$Family,]
rows2add2 = data.frame(Test = "Spring Ice Vs Cryoconite", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
data2plot = rbind(data2plot, rows2add2)
# data2plot = data2plot[order(data2plot$Phylum, decreasing = TRUE), ]
data2plot =arrange(data2plot ,desc(Phylum),Family)
...
#add empty rows for all the taxa we will include
rows2add = tax.data.fam[!tax.data.fam$Family %in% data2plot$Family,]
rows2add2 = data.frame(Test = "Summer Ice Vs Cryoconite", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
data2plot = rbind(data2plot, rows2add2)
# data2plot = data2plot[order(data2plot$Phylum, decreasing = TRUE), ]
data2plot =arrange(data2plot ,desc(Phylum),Family)
...
#add empty rows for all the taxa we will include
data2plot = tax.data.fam[!tax.data.fam$Family %in% data2plot$Family,]
data2plot = data.frame(Test = "Snow Vs Spring Ice", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=data2plot$Kingdom, Phylum=data2plot$Phylum, Class=data2plot$Class, Order=data2plot$Order, Family=data2plot$Family,
                       Genus=NA, Species=NA)
...
#add empty rows for all the taxa we will include
rows2add = tax.data.fam[!tax.data.fam$Family %in% data2plot$Family,]
rows2add2 = data.frame(Test = "Spring Ice Vs Summer Ice", baseMean=0, log2FoldChange=0, lfcSE=0, stat=0, pvalue=0, padj=0, Kingdom=rows2add$Kingdom, Phylum=rows2add$Phylum, Class=rows2add$Class, Order=rows2add$Order, Family=rows2add$Family,
                       Genus=NA, Species=NA)
data2plot = rbind(data2plot, rows2add2)
# data2plot = data2plot[order(data2plot$Phylum, decreasing = TRUE), ]
data2plot =arrange(data2plot ,desc(Phylum),Family)
...
pdf("../results-proportional/daa-pro-euk.pdf", width=15, height=5)
print(all.p)
dev.off()
