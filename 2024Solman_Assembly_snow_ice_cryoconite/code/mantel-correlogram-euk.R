...
euk.sn$Group = "Microbial Eukaryote"
euk.sn$Habitat = "Snow"
euk.sp$Group = "Microbial Eukaryote"
euk.sp$Habitat = "Spring Ice"
euk.sm$Group = "Microbial Eukaryote"
euk.sm$Habitat = "Summer Ice"
euk.cr$Group = "Microbial Eukaryote"
euk.cr$Habitat = "Cryoconite"

plot.df = rbind(euk.sn, euk.sp, euk.sm, euk.cr)

write.csv(plot.df, "../results/eukaryote-mantel-results.csv")