...
#After looking at total RNA quality using trimmomatic to trim the reads
#See trimmomatic text file - run commands on HPC

#Run phyloflash on quality controlled reads
#See phyloflash text file - run commands on HPC
...
#prep the RNA data for analysis and create phyloseq objects
Rscript mt-rna-data-prep.R

#examine control samples
Rscript mt-control-samples.R

#get basic community stats
Rscript mt-community-stats.R

#get community profile plots
Rscript mt-community-barplots.R