...
#Save within.bNTI.df
write.table(within.bNTI.df, "within.bNTI.df.txt")
...
eco.bNTI.plot = ggplot(within.bNTI.df, aes(x=Glacier, y=bNTI)) +
  ...
  theme(legend.position = "none",
        ...
        axis.title = element_text(size=14))+
  ylim(-2, 10)+
  ggtitle("Total Taxa βNTI Results")


#save pdf
pdf("eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "eco.turnover.df.txt")
