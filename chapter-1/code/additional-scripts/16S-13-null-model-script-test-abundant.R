...
new.ps <- rarefy_even_depth(ps.abun, sample.size = 2)
...
#Save crlg table
write.table(crlg, "abundant-crlg.txt")
...
#save pdf
pdf("abundant-mantel-correlogram.pdf")
print(p)
dev.off()
...
#Save bNTI table
write.table(full.bNTI.df, "abundant-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "abundant-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "abundant-within.bNTI.df.txt")
...
#save pdf
pdf("abundant-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "abundant-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "abundant-final_data.txt")
...
#save pdf
pdf("abundant-eco.turnover.plot.pdf")
