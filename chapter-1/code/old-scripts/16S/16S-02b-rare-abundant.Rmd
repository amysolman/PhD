...
Function to find abundance class of ASV by Region
```{r}
...
Function to subset phyloseq objects by ASV class
```{r}
phylo <- ps.rar
#space <- "Region"
name <- "McMurdo_Dry_Valleys"
...
phylo_abundance_subset <- function(phylo, name, rare, abundant){
  
  df <- am_i_abundant_region(phylo, name, rare, abundant)
