...
#TOTAL DATASET
#ps <- readRDS("../../results/16S/phylo-objects/16S-phyloseq-object-intermediatefied-decontam.rds")

# #Total intermediate
#ps.abun <- readRDS("../../results/16S/phylo-objects/16S-total-abundant.rds")
# #Total intermediate
ps.int <- readRDS("data-output/16S-total-intermediate.rds")
# #Total intermediate
# ps.rare <- readRDS("../data-output/16S/phylo-objects/16S-total-rare.rds")


set.seed(6666)
#I know my data is even sampling depth so I'm just going to get relative abundances
#get relative abundances
#intermediatefy to small sample depth so I can run this code on my computer
#new.ps <- intermediatefy_even_depth(ps.intermediate, sample.size = 2)
...
#Save crlg table
write.table(crlg, "results/16S-intermediate-crlg.txt")
...
#save pdf
pdf("results/16S-intermediate-mantel-correlogram.pdf")
print(p)
dev.off()


# intermediatefy to an even depth
set.seed(72)  # setting seed for reproducibility
# bulk.physeq.intermediate = intermediatefy_even_depth(bulk.physeq)
...
#Save bNTI table
write.table(full.bNTI.df, "results/16S-intermediate-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "results/16S-intermediate-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "results/16S-intermediate-within.bNTI.df.txt")
...
eco.bNTI.plot = ggplot(within.bNTI.df, aes(x=Glacier, y=bNTI)) +
  ...
  theme(legend.position = "none",
        ...
        axis.title = element_text(size=14))+
  ylim(-2, 10)+
  ggtitle("Intermediate Community BNTI Results")


#save pdf
pdf("results/16S-intermediate-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "results/16S-intermediate-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "results/16S-intermediate-final_data.txt")
...
eco.turnover.plot = ggplot(final_data, aes(x=Glacier, y=perc, fill=process)) +
  ...
  ggtitle("Intermediate Community RC Bray Results")


#save pdf
pdf("results/16S-intermediate-eco.turnover.plot.pdf")
...
#save pdf
pdf("results/16S-intermediate-eco.plot.pdf")
print(eco.plot)
dev.off() 
