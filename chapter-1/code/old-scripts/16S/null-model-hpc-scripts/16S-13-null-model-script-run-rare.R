...
#Save crlg table
write.table(crlg, "results/16S-rare-crlg.txt")
...
#save pdf
pdf("results/16S-rare-mantel-correlogram.pdf")
print(p)
dev.off()
...
#Save bNTI table
write.table(full.bNTI.df, "results/16S-rare-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "results/16S-rare-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "results/16S-rare-within.bNTI.df.txt")
...
#save pdf
pdf("results/16S-rare-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "results/16S-rare-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "results/16S-rare-final_data.txt")
...
#save pdf
pdf("results/16S-rare-eco.turnover.plot.pdf")
...
#save pdf
pdf("results/16S-rare-eco.plot.pdf")
print(eco.plot)
dev.off() 
