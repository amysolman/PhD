...
ps <- readRDS("data-output/16S-phyloseq-object-rarefied-decontam.rds")
...
#Save crlg table
write.table(crlg, "results/16S-total-crlg.txt")
...
#save pdf
pdf("results/16S-total-mantel-correlogram.pdf")
print(p)
dev.off()
...
#Save bNTI table
write.table(full.bNTI.df, "results/16S-total-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "results/16S-total-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "results/16S-total-within.bNTI.df.txt")
...
#save pdf
pdf("results/16S-total-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "results/16S-total-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "results/16S-total-final_data.txt")
...
#save pdf
pdf("results/16S-total-eco.turnover.plot.pdf")
...
#save pdf
pdf("results/16S-total-eco.plot.pdf")
print(eco.plot)
dev.off() 
