...
# 
# #save plot
#     pdf(paste0("../../results/18S/graphs/neutral-model/", pole, "-neutral-model.pdf"))
#     print(p)
#     dev.off()
# }
...
#get fake frequencies
# fake_freq <- vector <- rexp(nrow(freq.df))/10
# freq.df$freq <- fake_freq
#fake_freq <- unique(freq.df$freq)[]
...
#save plot
    pdf(paste0("../../results/18S/graphs/neutral-model/18S-neutral-model.pdf"))
    print(p)
    dev.off()
...
print(p1)
ggsave("../../results/18S/graphs/neutral-model/18S-prediction-ratio.pdf")
...
#save plot
    pdf(paste0("../../results/18S/graphs/neutral-model/18S-neutral-model-predictions.pdf"))
    print(p2)
    dev.off()
}
