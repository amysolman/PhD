...
ps.rar <- readRDS("../../results/18S/phylo-objects/18S-phyloseq-object-rarefied.rds") #load unrarefied phyloseq object
...
#Total rare
saveRDS(ps.rare, "../../results/18S/phylo-objects/18S-total-rare.rds")
#Total Abundant
saveRDS(ps.abun, "../../results/18S/phylo-objects/18S-total-abundant.rds")
#Total Intermediate 
saveRDS(ps.int, "../../results/18S/phylo-objects/18S-total-intermediate.rds")
```