...
plot_ordination(ps, ordBC, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("18S:PCoA Total Community Bray-Curtis")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-bray-curtis-glacier.pdf")

plot_ordination(ps, ordWU, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("18S: PCoA Total Community Weighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-wuni-glacier.pdf")

plot_ordination(ps, ordUU, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("18S: PCoA Total Community Unweighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-uwuni-glacier.pdf")
...
plot_ordination(ps, ordBC, color = "Region", shape="Pole") + 
  #geom_point() +
  ggtitle("18S: PCoA Total Community Bray-Curtis")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-bray-curtis-region.pdf")

plot_ordination(ps, ordWU, color = "Region", shape="Pole") + 
  #geom_point() +
  ggtitle("18S: PCoA Total Community Weighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-wuni-region.pdf")

plot_ordination(ps, ordUU, color = "Region", shape="Pole") + 
  #geom_point() +
  ggtitle("18S: PCoA Total Community Unweighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-uwuni-region.pdf")
...
plot_ordination(ps, ordBC, color = "Pole") + 
  ...
  stat_ellipse(type="t") +
  ggtitle("18S: PCoA Total Community Bray-Curtis")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-bray-curtis-pole.pdf")

plot_ordination(ps, ordWU, color = "Pole") + 
  #geom_point() +
  stat_ellipse() +
  ggtitle("18S: PCoA Total Community Weighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-wuni-pole.pdf")

plot_ordination(ps, ordUU, color = "Pole") + 
  #geom_point() +
  stat_ellipse() +
  ggtitle("18S: PCoA Total Community Unweighted Unifrac")
ggsave("../../results/18S/graphs/beta-ordination/PCoA-uwuni-pole.pdf")
...
plot_ordination(
  ...
  ordination = ps_nmds,
  color = "Glacier",
  title = "18S: NMDS Plot by Glacier"
)
ggsave("../../results/18S/graphs/beta-ordination/NMDS-glacier.pdf")

plot_ordination(
  physeq = ps,
  ordination = ps_nmds,
  color = "Region",
  title = "18S: NMDS Plot by Region"
)
ggsave("../../results/18S/graphs/beta-ordination/NMDS-region.pdf")

plot_ordination(
  physeq = ps,
  ordination = ps_nmds,
  color = "Pole",
  title = "18S: NMDS Plot by Pole"
)
ggsave("../../results/18S/graphs/beta-ordination/NMDS-pole.pdf")
...
plot_ordination(ps.abun, ordBC_ab, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Bray-Curtis by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-bray-curtis-glacier.pdf")

plot_ordination(ps.abun, ordWU_ab, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Weighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-wuni-glacier.pdf")

plot_ordination(ps.abun, ordUU_ab, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Unweighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-uwuni-glacier.pdf")


#Region
plot_ordination(ps.abun, ordBC_ab, color = "Region", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Bray-Curtis by Region")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-bray-curtis-region.pdf")

plot_ordination(ps.abun, ordWU_ab, color = "Region", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Weighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-wuni-region.pdf")

plot_ordination(ps.abun, ordUU_ab, color = "Region", shape="Pole") + 
  ggtitle("18S: Abundant PCoA Unweighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-uwuni-region.pdf")
...
plot_ordination(ps.abun, ordBC_ab, color = "Pole") + 
  stat_ellipse(type="t") +
  ggtitle("18S: Abundant PCoA Bray-Curtis by Pole")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-bray-curtis-pole.pdf")

plot_ordination(ps.abun, ordWU_ab, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Abundant PCoA Weighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-wuni-pole.pdf")

plot_ordination(ps.abun, ordUU_ab, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Abundant PCoA Unweighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/abundant-PCoA-uwuni-pole.pdf")
...
plot_ordination(
  ...
  color = "Glacier",
  title = "18S: Abundant NMDS Plot by Glacier"
)
ggsave("../../results/18S/graphs/beta-ordination/abundant-NMDS-glacier.pdf")

plot_ordination(
  physeq = ps.abun,
  ordination = abun_nmds,
  color = "Region",
  title = "18S: Abundant NMDS Plot by Region"
)
ggsave("../../results/18S/graphs/beta-ordination/abundant-NMDS-region.pdf")

plot_ordination(
  physeq = ps.abun,
  ordination = abun_nmds,
  color = "Pole",
  title = "18S: Abundant NMDS Plot by Pole"
)
ggsave("../../results/18S/graphs/beta-ordination/abundant-NMDS-pole.pdf")
...
plot_ordination(ps.int, ordBC_i, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Bray-Curtis by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-bray-curtis-glacier.pdf")

plot_ordination(ps.int, ordWU_i, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Weighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-wuni-glacier.pdf")

plot_ordination(ps.int, ordUU_i, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Unweighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-uwuni-glacier.pdf")


#Region
plot_ordination(ps.int, ordBC_i, color = "Region", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Bray-Curtis by Region")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-bray-curtis-region.pdf")

plot_ordination(ps.int, ordWU_i, color = "Region", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Weighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-wuni-region.pdf")

plot_ordination(ps.int, ordUU_i, color = "Region", shape="Pole") + 
  ggtitle("18S: Intermediate PCoA Unweighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-uwuni-region.pdf")


#Pole
plot_ordination(ps.int, ordBC_i, color = "Pole") + 
  stat_ellipse(type="t") +
  ggtitle("18S: Intermediate PCoA Bray-Curtis by Pole")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-bray-curtis-pole.pdf")

plot_ordination(ps.int, ordWU_i, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Intermediate PCoA Weighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-wuni-pole.pdf")

plot_ordination(ps.int, ordUU_i, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Intermediate PCoA Unweighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/intermediate-PCoA-uwuni-pole.pdf")
...
plot_ordination(
  ...
  ordination = int_nmds,
  color = "Glacier",
  title = "18S: Intermediate NMDS Plot by Glacier"
)
ggsave("../../results/18S/graphs/beta-ordination/intermediate-NMDS-glacier.pdf")

plot_ordination(
  physeq = ps.int,
  ordination = int_nmds,
  color = "Region",
  title = "18S: Intermediate NMDS Plot by Region"
)
ggsave("../../results/18S/graphs/beta-ordination/intermediate-NMDS-region.pdf")

plot_ordination(
  physeq = ps.int,
  ordination = int_nmds,
  color = "Pole",
  title = "18S: Intermediate NMDS Plot by Pole"
)
ggsave("../../results/18S/graphs/beta-ordination/intermediate-NMDS-pole.pdf")
```
...
plot_ordination(ps.rare, ordBC_ra, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Rare PCoA Bray-Curtis by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-bray-curtis-glacier.pdf")

plot_ordination(ps.rare, ordWU_ra, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Rare PCoA Weighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-wuni-glacier.pdf")

plot_ordination(ps.rare, ordUU_ra, color = "Glacier", shape="Pole") + 
  ggtitle("18S: Rare PCoA Unweighted Unifrac by Glacier")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-uwuni-glacier.pdf")


#Region
plot_ordination(ps.rare, ordBC_ra, color = "Region", shape="Pole") + 
  ggtitle("18S: Rare PCoA Bray-Curtis by Region")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-bray-curtis-region.pdf")

plot_ordination(ps.rare, ordWU_ra, color = "Region", shape="Pole") + 
  ggtitle("18S: Rare PCoA Weighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-wuni-region.pdf")

plot_ordination(ps.rare, ordUU_ra, color = "Region", shape="Pole") + 
  ggtitle("18S: Rare PCoA Unweighted Unifrac by Region")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-uwuni-region.pdf")


#Pole
plot_ordination(ps.rare, ordBC_ra, color = "Pole") + 
  stat_ellipse(type="t") +
  ggtitle("18S: Rare PCoA Bray-Curtis by Pole")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-bray-curtis-pole.pdf")

plot_ordination(ps.rare, ordWU_ra, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Rare PCoA Weighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-wuni-pole.pdf")

plot_ordination(ps.rare, ordUU_ra, color = "Pole") + 
  stat_ellipse() +
  ggtitle("18S: Rare PCoA Unweighted Unifrac by Pole")
ggsave("../../results/18S/graphs/beta-ordination/rare-PCoA-uwuni-pole.pdf")
...
plot_ordination(
  ...
  color = "Glacier",
  title = "18S: Rare NMDS Plot by Glacier"
)
ggsave("../../results/18S/graphs/beta-ordination/rare-NMDS-glacier.pdf")

plot_ordination(
  physeq = ps.rare,
  ordination = ps.rare_nmds,
  color = "Region",
  title = "18S: Rare NMDS Plot by Region"
)
ggsave("../../results/18S/graphs/beta-ordination/rare-NMDS-region.pdf")

plot_ordination(
  physeq = ps.rare,
  ordination = ps.rare_nmds,
  color = "Pole",
    title = "18S: Rare NMDS Plot by Pole"
)
ggsave("../../results/18S/graphs/beta-ordination/rare-NMDS-pole.pdf")
