...
p1 <- ggplot(ps.glom, aes(x = Glacier, y = Abundance, fill = Phylum)) +
  ...
  ggtitle("18S: Phyla Barplot by Glacier")
print(p1)
ggsave("../../results/18S/graphs/community-plots/phyla-glacier-barplot.pdf")
...
ggplot(ps.glom, aes(x = Region, y = Abundance, fill = Phylum)) +
  ...
  xlab("Region")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  ggtitle("18S: Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/phyla-region-barplot.pdf")
...
ggplot(ps.glom, aes(x = Pole, y = Abundance, fill = Phylum)) +
  ...
  xlab("Pole")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  ggtitle("18S: Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/phyla-pole-barplot.pdf")
...
write.csv(total_phyla_table, "../../results/18S/tables/phyla/total-phyla-data.csv")
```
...
phyloseq::plot_bar(ps_rel_abund, fill = "Phylum") +
  ...
  ggtitle("18S: Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/phyla-glacier-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
  ggtitle("18S: Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/phyla-region-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
  ggtitle("18S: Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/phyla-pole-barplot-2.pdf")
...
ggplot(data = ., aes(x = Pole, y = Abundance)) +
  ...
  ggtitle("18S: Phyla by pole")
ggsave("../../results/18S/graphs/community-plots/phyla-pole-scatterplot.pdf")
...
pdf("../../results/18S/graphs/community-plots/phyla-pie-chart.pdf")
...
ggplot(abun.glom, aes(x = Glacier, y = Abundance, fill = Phylum)) +
  ...
  xlab("Glacier")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
    ggtitle("18S: Abundant Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-glacier-barplot.pdf")
...
ggplot(abun.glom, aes(x = Region, y = Abundance, fill = Phylum)) +
  ...
  xlab("Region")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  ggtitle("18S: Abundant Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-region-barplot.pdf")
...
ggplot(abun.glom, aes(x = Pole, y = Abundance, fill = Phylum)) +
  ...
  xlab("Pole")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
    ggtitle("18S: Abundant Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-pole-barplot.pdf")
```
...
write.csv(abun_phyla_table, "../../results/18S/tables/phyla/abundant-phyla-data.csv")
```
...
phyloseq::plot_bar(ps_rel_abund.ab, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
    ggtitle("18S: Abundant Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-glacier-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.ab, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
    ggtitle("18S: Abundant Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-region-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.ab, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
    ggtitle("18S: Abundant Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-pole-barplot-2.pdf")
...
ggplot(data = ., aes(x = Pole, y = Abundance)) +
  ...
  labs(x = "", y = "Abundance\n") +
  facet_wrap(~ Phylum, scales = "free")+
    ggtitle("18S: Abundant Phyla by pole")
ggsave("../../results/18S/graphs/community-plots/abundant-phyla-pole-scatterplot.pdf")
...
pdf("../../results/18S/graphs/community-plots/abundant-phyla-pie-chart.pdf")
...
ggplot(ps.int.glom, aes(x = Glacier, y = Abundance, fill = Phylum)) +
  ...
  xlab("Glacier")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
      ggtitle("18S: Intermediate Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-glacier-barplot.pdf")
...
ggplot(ps.int.glom, aes(x = Region, y = Abundance, fill = Phylum)) +
  ...
  xlab("Region")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
    ggtitle("18S: Intermediate Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-region-barplot.pdf")
...
ggplot(ps.int.glom, aes(x = Pole, y = Abundance, fill = Phylum)) +
  ...
  xlab("Pole")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
      ggtitle("18S: Intermediate Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-pole-barplot.pdf")
...
write.csv(int_phyla_table, "../../results/18S/tables/phyla/intermediate-phyla-data.csv")
```
...
phyloseq::plot_bar(ps_rel_abund.i, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
      ggtitle("18S: Intermediate Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-glacier-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.i, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
      ggtitle("18S: Intermediate Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-region-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.i, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
      ggtitle("18S: Intermediate Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-pole-barplot-2.pdf")
...
ggplot(data = ., aes(x = Pole, y = Abundance)) +
  ...
  labs(x = "", y = "Abundance\n") +
  facet_wrap(~ Phylum, scales = "free")+
      ggtitle("18S: Intermediate Phyla by pole")
ggsave("../../results/18S/graphs/community-plots/intermediate-phyla-pole-scatterplot.pdf")
...
newdf$lbls <- paste(newdf$lbls,"%",sep="") # ad % to labels 
#pie(newdf$pct, labels = newdf$lbls, col=rainbow(length(newdf$pct)), radius = 0.9, cex = 0.4)
pdf("../../results/18S/graphs/community-plots/intermediate-phyla-pie-chart.pdf")
...
ggplot(rare.glom, aes(x = Glacier, y = Abundance, fill = Phylum)) +
  ...
  xlab("Glacier")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
        ggtitle("18S: Rare Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-glacier-barplot.pdf")
...
ggplot(rare.glom, aes(x = Region, y = Abundance, fill = Phylum)) +
  ...
  xlab("Region")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
      ggtitle("18S: Rare Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-region-barplot.pdf")
...
ggplot(rare.glom, aes(x = Pole, y = Abundance, fill = Phylum)) +
  ...
  xlab("Pole")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
        ggtitle("18S: Rare Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-pole-barplot.pdf")
```
Stats
```{r}
#How many/which phyla total dataset? Relative abundance of each phyla.
...
write.csv(rare_phyla_table, "../../results/18S/tables/phyla/rare-phyla-data.csv")
```
...
phyloseq::plot_bar(ps_rel_abund.ra, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
        ggtitle("18S: Rare Phyla Barplot by Glacier")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-glacier-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.ra, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
        ggtitle("18S: Rare Phyla Barplot by Region")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-region-barplot-2.pdf")
...
phyloseq::plot_bar(ps_rel_abund.ra, fill = "Phylum") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.ticks.x=element_blank())+
        ggtitle("18S: Rare Phyla Barplot by Pole")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-pole-barplot-2.pdf")
...
ggplot(data = ., aes(x = Pole, y = Abundance)) +
  ...
  labs(x = "", y = "Abundance\n") +
  facet_wrap(~ Phylum, scales = "free")+
        ggtitle("18S: Rare Phyla by pole")
ggsave("../../results/18S/graphs/community-plots/rare-phyla-pole-scatterplot.pdf")
...
newdf$lbls <- paste(newdf$lbls,"%",sep="") # ad % to labels 
#pie(newdf$pct, labels = newdf$lbls, col=rainbow(length(newdf$pct)), radius = 1, cex = 0.3)
pdf("../../results/18S/graphs/community-plots/rare-phyla-pie-chart.pdf")
