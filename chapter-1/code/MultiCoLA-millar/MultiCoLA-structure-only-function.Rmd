---
title: 'MultiCoLA: Community Structure Only'
author: "Amy Solman"
date: "21/02/2022"
...
MultiCoLA: Community Structure Analysis Only

This function combines the scripts creates by Gobe et al., (2010) with my own, to output results for any phyloseq object.

Contents and output of this function:
...
4) Calculate of Spearman (or Pearson, Kendall) correlations and Procrustes correlations between the original dataset and the truncated ones
...
data_set_based_structure_only_MultiCoLA(ps_euk_arc_filter, "Arctic", "18S")
data_set_based_structure_only_MultiCoLA(ps_euk_ant_filter, "Antarctic", "18S")
