...
```{r}
ps.ambig <- subset_taxa(my_phyloseq, !is.na(Kingdom) & !Kingdom %in% c("Unassigned") & !Order %in% c("Chloroplast") & !Family %in% c("Mitochondria"))
ps.ambig
...
ps.prune <- prune_samples(sample_sums(ps.ambig) >= 10000, ps.ambig) 
ps.prune
```
