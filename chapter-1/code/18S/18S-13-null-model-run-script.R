...
#Save RCb.df table
write.table(RCb.df, "results/18S-total-RCb.df.txt")

#Plot results
x.1 = data.frame(sample_data(ps)) %>%
...
#Save within.bNTI.df
write.table(within.bNTI.df, "results/18S-total-within.bNTI.df.txt")
...
eco.bNTI.plot = ggplot(within.bNTI.df, aes(x=Glacier, y=bNTI)) +
  ...
  theme(legend.position = "none",
        ...
        axis.title = element_text(size=14))+
  ylim(-2, 10)+
  ggtitle("Total Taxa BNTI Results")


#save pdf
pdf("results/18S-total-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "results/18S-total-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "results/18S-total-final_data.txt")
...
eco.turnover.plot = ggplot(final_data, aes(x=Glacier, y=perc, fill=process)) +
  ...
  ggtitle("Total Taxa RC Bray Results")


#save pdf
pdf("results/18S-total-eco.turnover.plot.pdf")
...
#save pdf
pdf("results/18S-total-eco.plot.pdf")
print(eco.plot)
dev.off() 
