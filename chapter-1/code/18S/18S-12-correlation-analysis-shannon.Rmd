...
shapiro.test(samp_data$Shannon) # p > 0.05 data NOT significantly different from normal distribution so we need to might be able to use parametric test
...
#First check normality assumptions
# Shapiro-Wilk normality test for mpg
shapiro.test(samp_data.ab$Shannon) # p > 0.05 data NOT significantly different from normal distribution so we need to might be able to use parametric test
...
for (i in 1:nrow(df.ab)){
 ...
 #list_plots[[k]] <- 
    pdf(paste0("../data-output/cor-plots/shannon/abundant/correlation-plot-", df.ab[,1][i], ".pdf"))
...
#First check normality assumptions
# Shapiro-Wilk normality test for mpg
shapiro.test(samp_data.i$Shannon) # p > 0.05 data NOT significantly different from normal distribution so we need to might be able to use parametric test
...
#First check normality assumptions
# Shapiro-Wilk normality test for mpg
shapiro.test(samp_data.ra$Shannon) # p > 0.05 data NOT significantly different from normal distribution so we need to might be able to use parametric test
