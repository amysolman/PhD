...
save_my_plots <- function(plots_list, index, group, community){
  ...
  for (p in 1:length(plots_list)){
    ...
    pdf(paste0("../../results/16S/graphs/correlation-analysis/", community, "-",as.character(plot_to_print$labels[1]), "-group-", group, ".pdf"))
    print(plot_to_print)
    dev.off()
  }
}
...
#save_my_plots(abun_plots_observed_group_2, "Observed", 2, "abundant") #no plots
...
save_my_plots(int_plots_shannon_group_1, "Shannon", 1, "intermediate")
#ps.int, shannon, group 2
int_plots_shannon_group_2 <- visualise_my_significance(ps.int, "Shannon", 2)
save_my_plots(int_plots_shannon_group_2, "Shannon", 2, "intermediate")
