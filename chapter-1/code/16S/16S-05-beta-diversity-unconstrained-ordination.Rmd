...
ggsave("../../results/16S/graphs/beta-ordination/PCoA-bray-uwuni-glacier.pdf")
...
plot_ordination(ps, ordUU, color = "Region", shape="Pole") + 
  #geom_point() +
  ggtitle("16S: PCoA Total Community Unweighted Unifrac")
ggsave("../../results/16S/graphs/beta-ordination/PCoA-bray-uwuni-region.pdf")
...
plot_ordination(ps, ordUU, color = "Pole") + 
  ...
  stat_ellipse() +
  ggtitle("16S: PCoA Total Community Unweighted Unifrac")
ggsave("../../results/16S/graphs/beta-ordination/PCoA-bray-uwuni-pole.pdf")
