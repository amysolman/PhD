...
plot_ordination(ps, ordBC, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("PCoA: Total Community Bray-Curtis")

plot_ordination(ps, ordWU, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("PCoA: Total Community Weighted Unifrac")

plot_ordination(ps, ordUU, color = "Glacier", shape="Pole") + 
  #geom_point() +
  ggtitle("PCoA: Total Community Unweighted Unifrac")
...
#R = 0.27 so low dissimilarity between glaciers
...
#R = 0.28 low dissimilarity between glaciers
...
#R = 0.33 low dissimilarity between glaciers
