...
# #Total abundant
ps.abun <- readRDS("data-output/16S-total-abundant.rds")
# #Total abundant
#ps.int <- readRDS("../data-output/16S-total-intermediate.rds")
# #Total abundant
# ps.rare <- readRDS("../data-output/16S-total-rare.rds")
...
#Save crlg table
write.table(crlg, "results/16S-abundant-crlg.txt")
...
#save pdf
pdf("results/16S-abundant-mantel-correlogram.pdf")
print(p)
dev.off()
...
#Save bNTI table
write.table(full.bNTI.df, "results/16S-abundant-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "results/16S-abundant-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "results/16S-abundant-within.bNTI.df.txt")
...
#save pdf
pdf("results/16S-abundant-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "results/16S-abundant-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "results/16S-abundant-final_data.txt")
...
#save pdf
pdf("results/16S-abundant-eco.turnover.plot.pdf")
...
#save pdf
pdf("results/16S-abundant-eco.plot.pdf")
print(eco.plot)
dev.off() 