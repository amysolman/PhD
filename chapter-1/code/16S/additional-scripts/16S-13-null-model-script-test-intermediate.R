...
new.ps <- rarefy_even_depth(ps.int, sample.size = 2)
...
#Save crlg table
write.table(crlg, "intermediate-crlg.txt")
...
#save pdf
pdf("intermediate-mantel-correlogram.pdf")
print(p)
dev.off()
...
#Save bNTI table
write.table(full.bNTI.df, "intermediate-full_bNTI.txt")
...
#Save RCb.df table
write.table(RCb.df, "intermediate-RCb.df.txt")
...
#Save within.bNTI.df
write.table(within.bNTI.df, "intermediate-within.bNTI.df.txt")
...
#save pdf
pdf("intermediate-eco.bNTI.plot.pdf")
print(eco.bNTI.plot)
dev.off()
...
write.table(eco.turnover.df, "intermediate-eco.turnover.df.txt")
...
#Save final_data
write.table(final_data, "intermediate-final_data.txt")
...
#save pdf
pdf("intermediate-eco.turnover.plot.pdf")
