...
rare_rich <- estimate_richness(ps.rare)
...
ggplot(data_stack, aes(fill=Abundance, y=Observed, x=SampleID)) + 
  ...
  ggtitle("16S: Stacked Barplot of Abundance Richness Across All Samples")+
    theme(axis.text.x = element_text(angle=90, hjust=1))
ggsave("../../results/16S/graphs/alpha-diversity/stacked-sample.pdf")

# Stacked + percent
ggplot(data_stack, aes(fill=Abundance, y=Observed, x=Glacier)) + 
    geom_bar(position="fill", stat="identity")+
  ggtitle("16S: Stacked Barplot of Abundance Richness Between Glaciers")+
  theme(axis.text.x = element_text(angle=90, hjust=1))
ggsave("../../results/16S/graphs/alpha-diversity/stacked-glacier.pdf")

# Stacked + percent
ggplot(data_stack, aes(fill=Abundance, y=Observed, x=Pole)) + 
    geom_bar(position="fill", stat="identity")+
  ggtitle("16S: Stacked Barplot of Abundance Richness Between Poles")
ggsave("../../results/16S/graphs/alpha-diversity/stacked-poles.pdf")
...
ggplot(data=data1, aes(x=SampleID, y=Observed, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Total Community Richness")+
...
ggsave("../../results/16S/graphs/alpha-diversity/richness-sample.pdf")
...
ggplot(data=data1, aes(x=SampleID, y=Shannon, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Total Community Shannon Diversity")+
...
ggsave("../../results/16S/graphs/alpha-diversity/shannon-sample.pdf")
...
ggplot(data=tot_glacier, aes(x=Glacier, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16: Total Community Richness by Glacier")+
  ...
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)
ggsave("../../results/16S/graphs/alpha-diversity/richness-glacier.pdf")
...
ggplot(data=tot_glacier, aes(x=Glacier, y=Shannon, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16: Total Community Shannon Diversity by Glacier")+
  ...
  geom_bar(data=subset(tot_glacier, Shannon==max(Shannon)), aes(Glacier, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/shannon-glacier.pdf")
...
p = plot_richness(ps, x="Glacier", color="Pole", measures=c("Observed", "Shannon")) + geom_boxplot()+
  ggtitle("16S: Total Community Richness and Shannon Diversity Boxplots")


p$data$Glacier <- as.character(p$data$Glacier)
p$data$Glacier <- factor(p$data$Glacier, levels=newSTorder)
print(p)
ggsave("../../results/16S/graphs/alpha-diversity/shannon-richness-glacier-boxplot.pdf")
...
ggplot(data1, aes(x=Pole, y=Observed, fill=Pole)) + 
  ...
  theme_classic()+
  ggtitle("16S: Total Community Observed ASVs by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/richness-pole-boxplot.pdf")
...
ggplot(data1, aes(x=Pole, y=Shannon, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Total Community Shannon Index by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/shannon-pole-boxplot.pdf")
...
ggplot(data=tot_pole, aes(x=Pole, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Total Community Richness by Pole")+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=5)
ggsave("../../results/16S/graphs/alpha-diversity/richness-pole-barplot.pdf")
...
t.test(Shannon ~ Pole, data = data1, var.equal = TRUE) #p > 0.05 no significant difference
```
...
ggplot(data=data2, aes(x=SampleID, y=Observed, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Abundant Community Richness")+
  ...
  geom_bar(data=subset(data2, Observed==max(Observed)), aes(SampleID, Observed),
              color="black", stat="identity")+
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-richness-sample.pdf")
...
ggplot(data=data2, aes(x=SampleID, y=Shannon, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Abundant Community Shannon Diversity")+
  ...
  geom_bar(data=subset(data2, Shannon==max(Shannon)), aes(SampleID, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-shannon-sample.pdf")
```
...
ggplot(data=abun_glacier, aes(x=Glacier, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Abundant Community Richness by Glacier")+
  ...
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-richness-glacier.pdf")
...
ggplot(data=abun_glacier, aes(x=Glacier, y=Shannon, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Abundant Community Shannon Diversity by Glacier")+
  ...
  geom_bar(data=subset(abun_glacier, Shannon==max(Shannon)), aes(Glacier, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-shannon-glacier.pdf")

#Total by glacier
p2 = plot_richness(ps.abun, x="Glacier", color="Pole", measures=c("Observed", "Shannon")) + geom_boxplot()+
  ggtitle("16S: Abundant Community Richness and Shannon Diversity Boxplots")

p2$data$Glacier <- as.character(p2$data$Glacier)
p2$data$Glacier <- factor(p2$data$Glacier, levels=newSTorder)
print(p2)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-shannon-richness-glacier-boxplot.pdf")
...
ggplot(data2, aes(x=Pole, y=Observed, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Abundant Community Observed ASVs by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/abundant-richness-pole-boxplot.pdf")
...
ggplot(data2, aes(x=Pole, y=Shannon, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Abundant Community Shannon Index by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/abundant-shannon-pole-boxplot.pdf")
...
ggplot(data=abun_pole, aes(x=Pole, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Abundant Community Richness by Pole")+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=5)
ggsave("../../results/16S/graphs/alpha-diversity/abundant-richness-pole-barplot.pdf")

#differences in observed ASVs
#check normality of data
with(data2, shapiro.test(Observed[Pole == "Arctic"]))# p < 0.05 not normally distributed
...
#NEED PARAMETRIC TEST
t.test(Shannon ~ Pole, data = data1, var.equal = TRUE) #p > 0.05 no significant differences
```
...
ggplot(data=data3, aes(x=SampleID, y=Observed, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Intermediate Community Richness")+
  ...
  geom_bar(data=subset(data3, Observed==max(Observed)), aes(SampleID, Observed),
              color="black", stat="identity")+
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-richness-sample.pdf")
...
ggplot(data=data3, aes(x=SampleID, y=Shannon, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Intermediate Community Shannon Diversity")+
  ...
  geom_bar(data=subset(data3, Shannon==max(Shannon)), aes(SampleID, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-shannon-sample.pdf")
```
...
ggplot(data=int_glacier, aes(x=Glacier, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Intermediate Community Richness by Glacier")+
  ...
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-richness-glacier.pdf")
...
ggplot(data=int_glacier, aes(x=Glacier, y=Shannon, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Intermediate Community Shannon Diversity by Glacier")+
  ...
  geom_bar(data=subset(int_glacier, Shannon==max(Shannon)), aes(Glacier, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-shannon-glacier.pdf")

#Total by glacier
p3 = plot_richness(ps.int, x="Glacier", color="Pole", measures=c("Observed", "Shannon")) + geom_boxplot()+
  ggtitle("16S: Intermediate Community Richness and Shannon Diversity Boxplots")

p3$data$Glacier <- as.character(p3$data$Glacier)
p3$data$Glacier <- factor(p3$data$Glacier, levels=newSTorder)
print(p3)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-shannon-richness-glacier-boxplot.pdf")
...
#Run shapiro-wilk test
shapiro.test(x=anov_res3b) #p > 0.05 which suggests the data are normally distributed
...
ggplot(data3, aes(x=Pole, y=Observed, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Intermediate Community Observed ASVs by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-richness-pole-boxplot.pdf")
...
ggplot(data3, aes(x=Pole, y=Shannon, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Intermediate Community Shannon Index by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-shannon-pole-boxplot.pdf")
...
ggplot(data=int_pole, aes(x=Pole, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Intermediate Community Richness by Pole")+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=5)
ggsave("../../results/16S/graphs/alpha-diversity/intermediate-richness-pole-barplot.pdf")
...
#differences in shannon diversity
#check normality of data
with(data3, shapiro.test(Shannon[Pole == "Arctic"]))# p < 0.05 not normally distributed
...
ggplot(data=data4, aes(x=SampleID, y=Observed, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Rare Community Richness")+
  ...
  geom_bar(data=subset(data4, Observed==max(Observed)), aes(SampleID, Observed),
              color="black", stat="identity")+
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/rare-richness-sample.pdf")
...
ggplot(data=data4, aes(x=SampleID, y=Shannon, fill=Glacier)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Rare Community Shannon Diversity")+
  ...
  geom_bar(data=subset(data4, Shannon==max(Shannon)), aes(SampleID, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/rare-shannon-sample.pdf")
```
...
ggplot(data=rare_glacier, aes(x=Glacier, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Rare Community Richness by Glacier")+
  ...
  geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=3)
ggsave("../../results/16S/graphs/alpha-diversity/rare-richness-glacier.pdf")
...
#ANOVA invalid!
#Which glaciers are different?
kruskal.test(Observed ~ Glacier, data = data4) #p > 0.05 so the differences between the medians are not statistically significant
...
ggplot(data=rare_glacier, aes(x=Glacier, y=Shannon, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Rare Community Shannon Diversity by Glacier")+
  ...
  geom_bar(data=subset(rare_glacier, Shannon==max(Shannon)), aes(Glacier, Shannon),
              color="black", stat="identity")+
  geom_text(aes(label=round(Shannon, digits=2)), vjust=1.6, color="white", size=2)
ggsave("../../results/16S/graphs/alpha-diversity/rare-shannon-glacier.pdf")

#Total by glacier
p4 = plot_richness(ps.rare, x="Glacier", color="Pole", measures=c("Observed", "Shannon")) + geom_boxplot()+
  ggtitle("16S: Rare Community Richness and Shannon Diversity Boxplots")

p4$data$Glacier <- as.character(p4$data$Glacier)
p4$data$Glacier <- factor(p4$data$Glacier, levels=newSTorder)
print(p4)
ggsave("../../results/16S/graphs/alpha-diversity/rare-shannon-richness-glacier-boxplot.pdf")
...
#Summary of analysis
summary(res4b) #p value > 0.05 no significant difference between glaciers
...
ggplot(data4, aes(x=Pole, y=Observed, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Rare Community Observed ASVs by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/rare-richness-pole-boxplot.pdf")
...
ggplot(data4, aes(x=Pole, y=Shannon, fill=Pole)) + 
  ...
  geom_jitter(shape=16, position=position_jitter(0.2))+
  theme_classic()+
  ggtitle("16S: Rare Community Shannon Index by Pole")
ggsave("../../results/16S/graphs/alpha-diversity/rare-shannon-pole-boxplot.pdf")
...
ggplot(data=rare_pole, aes(x=Pole, y=Observed, fill=Pole)) +
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle=90, hjust=1))+
  ggtitle("16S: Rare Community Richness by Pole")+
    geom_text(aes(label=Observed), vjust=1.6, color="white", size=5)
ggsave("../../results/16S/graphs/alpha-diversity/rare-richness-pole-barplot.pdf")

#differences in observed ASVs
#check normality of data
with(data4, shapiro.test(Observed[Pole == "Arctic"]))# p < 0.05 so not normally distributed
with(data4, shapiro.test(Observed[Pole == "Antarctic"])) #p > 0.05 normally distributed
#NEED NON-PARAMETRIC TEST
