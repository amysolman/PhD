...
signif_dif_nodes <- function(node_df, pole){
  ...
  p1 = p1 + # Add pairwise comparisons p-value
    stat_compare_means(label.y = layer_scales(p1)$y$range$range[2]*1.1, size=7)  # Add global p-value
  p1
  ...
  p2 = p2 + # Add pairwise comparisons p-value
    stat_compare_means(label.y = layer_scales(p2)$y$range$range[2]*1.2, size=7)  # Add global p-value
  p2
  ...
  p3 = p3 + # Add pairwise comparisons p-value
    stat_compare_means(label.y = layer_scales(p3)$y$range$range[2]*1.5, size=7)  # Add global p-value
  p3
  ...
  p4 = p4 + # Add pairwise comparisons p-value
    stat_compare_means(label.y = layer_scales(p4)$y$range$range[2]*1.5, size=7)  # Add global p-value
  p4
...
# prow <- plot_grid(
#   ant.plots[[1]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank()),
#   arc.plots[[1]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank()),
#   ant.plots[[2]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank()),
#   arc.plots[[2]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank()),
#   ant.plots[[3]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank()),
#   arc.plots[[3]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank()),
#   ant.plots[[4]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank()),
#   arc.plots[[4]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank()),
#   align = 'vh',
...
#make titles
#title1 <- ggdraw() + draw_label("Degrees                                                Betweenness                                     Closeness                                        Eigenvector Centrality", size=25, hjust=0.535, fontface = "bold")
title1 <- ggdraw() + draw_label("Degrees                               Betweenness                    Closeness                         Eigenvector Centrality", size=25, hjust=0.505, fontface = "bold")

final.p = 
  title1 /
((ant.plots[[1]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), strip.text = element_text(size=25))) |
(ant.plots[[2]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), strip.text = element_text(size=25))) |
(ant.plots[[3]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), strip.text = element_text(size=25))) |
(ant.plots[[4]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), strip.text = element_text(size=25)))) /
((arc.plots[[1]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank(), strip.text = element_text(size=25))) |
(arc.plots[[2]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank(), strip.text = element_text(size=25))) |
(arc.plots[[3]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank(), strip.text = element_text(size=25))) |
(arc.plots[[4]] + theme(legend.position="none", axis.text.x=element_blank(), axis.title = element_blank(), axis.ticks.x = element_blank(), axis.title.y = element_blank(), strip.text = element_text(size=25)))) +
plot_layout(heights = c(0.1,1,1))

final.p

#save plot
pdf("../results/node-properties-plot.pdf", width=17, height=12)
print(final.p)
dev.off()
